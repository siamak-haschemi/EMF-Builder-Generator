...
public class StateMachineBuilder {
  ...
  public StateMachineBuilder withNameExpression(org.eclipse.uml2.uml.util.builder.StringExpressionBuilder p_stringExpressionBuilder) {
  ...
  public StateMachineBuilder withOwnedTemplateSignature(org.eclipse.uml2.uml.util.builder.TemplateSignatureBuilder p_templateSignatureBuilder) {
  ...
  public StateMachineBuilder withOwningTemplateParameter(org.eclipse.uml2.uml.util.builder.TemplateParameterBuilder p_templateParameterBuilder) {
  ...
  public StateMachineBuilder withRepresentation(org.eclipse.uml2.uml.util.builder.CollaborationUseBuilder p_collaborationUseBuilder) {
  ...
  public StateMachineBuilder withTemplateParameter(org.eclipse.uml2.uml.util.builder.TemplateParameterBuilder p_templateParameterBuilder) {
  ...
  public StateMachineBuilder withClientDependency(DependencyBuilder p_dependencyBuilder) {
  ...
  public StateMachineBuilder withCollaborationUse(CollaborationUseBuilder p_collaborationUseBuilder) {
  ...
  public StateMachineBuilder withConnectionPoint(PseudostateBuilder p_pseudostateBuilder) {
  ...
  public StateMachineBuilder withElementImport(ElementImportBuilder p_elementImportBuilder) {
  ...
  public StateMachineBuilder withExtendedStateMachine(StateMachineBuilder p_stateMachineBuilder) {
  ...
  public StateMachineBuilder withGeneralization(GeneralizationBuilder p_generalizationBuilder) {
  ...
  public StateMachineBuilder withInterfaceRealization(InterfaceRealizationBuilder p_interfaceRealizationBuilder) {
  ...
  public StateMachineBuilder withOwnedAttribute(PropertyBuilder p_propertyBuilder) {
  ...
  public StateMachineBuilder withOwnedComment(CommentBuilder p_commentBuilder) {
  ...
  public StateMachineBuilder withOwnedConnector(ConnectorBuilder p_connectorBuilder) {
  ...
  public StateMachineBuilder withOwnedOperation(OperationBuilder p_operationBuilder) {
  ...
  public StateMachineBuilder withOwnedParameter(ParameterBuilder p_parameterBuilder) {
  ...
  public StateMachineBuilder withOwnedParameterSet(ParameterSetBuilder p_parameterSetBuilder) {
  ...
  public StateMachineBuilder withOwnedReception(ReceptionBuilder p_receptionBuilder) {
  ...
  public StateMachineBuilder withOwnedRule(ConstraintBuilder p_constraintBuilder) {
  ...
  public StateMachineBuilder withOwnedTrigger(TriggerBuilder p_triggerBuilder) {
  ...
  public StateMachineBuilder withOwnedUseCase(UseCaseBuilder p_useCaseBuilder) {
  ...
  public StateMachineBuilder withPackageImport(PackageImportBuilder p_packageImportBuilder) {
  ...
  public StateMachineBuilder withPostcondition(ConstraintBuilder p_constraintBuilder) {
  ...
  public StateMachineBuilder withPowertypeExtent(GeneralizationSetBuilder p_generalizationSetBuilder) {
  ...
  public StateMachineBuilder withPrecondition(ConstraintBuilder p_constraintBuilder) {
  ...
  public StateMachineBuilder withRegion(RegionBuilder p_regionBuilder) {
  ...
  public StateMachineBuilder withSubmachineState(StateBuilder p_stateBuilder) {
  ...
  public StateMachineBuilder withSubstitution(SubstitutionBuilder p_substitutionBuilder) {
  ...
  public StateMachineBuilder withTemplateBinding(TemplateBindingBuilder p_templateBindingBuilder) {
  ...
  public StateMachineBuilder withUseCase(UseCaseBuilder p_useCaseBuilder) {
