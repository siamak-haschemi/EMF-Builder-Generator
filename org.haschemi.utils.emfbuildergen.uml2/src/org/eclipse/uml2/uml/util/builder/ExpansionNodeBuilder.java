...
/**
 * <!-- begin-user-doc --> 
 *   A builder for the model object ' <em><b>org.eclipse.uml2.uml.ExpansionNode</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class ExpansionNodeBuilder implements org.eclipse.uml2.uml.util.builder.IUmlBuilder<org.eclipse.uml2.uml.ExpansionNode> {
  ...
  private org.eclipse.uml2.uml.ExpansionRegion m_regionAsInput;
  private org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.ExpansionRegion> m_featureRegionAsInputBuilder;
  private org.eclipse.uml2.uml.ExpansionRegion m_regionAsOutput;
  private org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.ExpansionRegion> m_featureRegionAsOutputBuilder;
  ...
  private boolean m_featureRegionAsInputSet = false;
  private boolean m_featureRegionAsOutputSet = false;
   ...
   * @see #newExpansionNodeBuilder()
   */
  private ExpansionNodeBuilder() {
  }

  /**
   * This method creates a new instance of the ExpansionNodeBuilder.
   * @return new instance of the ExpansionNodeBuilder
   */
  public static ExpansionNodeBuilder newExpansionNodeBuilder() {
    return new ExpansionNodeBuilder();
  }

  /**
   * This method can be used to override attributes of the builder. It constructs a new builder and copies the current values to it.
   */
  public ExpansionNodeBuilder but() {
    ExpansionNodeBuilder _builder = newExpansionNodeBuilder();
    ...
    _builder.m_featureRegionAsInputSet = m_featureRegionAsInputSet;
    _builder.m_regionAsInput = m_regionAsInput;
    _builder.m_featureRegionAsInputBuilder = m_featureRegionAsInputBuilder;
    _builder.m_featureRegionAsOutputSet = m_featureRegionAsOutputSet;
    _builder.m_regionAsOutput = m_regionAsOutput;
    _builder.m_featureRegionAsOutputBuilder = m_featureRegionAsOutputBuilder;
  ...
  /**
   * This method constructs the final org.eclipse.uml2.uml.ExpansionNode type.
   * @return new instance of the org.eclipse.uml2.uml.ExpansionNode type
   */
  public org.eclipse.uml2.uml.ExpansionNode build() {
    final org.eclipse.uml2.uml.ExpansionNode _newInstance = org.eclipse.uml2.uml.UMLFactory.eINSTANCE.createExpansionNode();
    ...
    if (m_featureRegionAsInputSet) {
      _newInstance.setRegionAsInput(m_regionAsInput);
    } else {
      if (m_featureRegionAsInputBuilder != null) {
        _newInstance.setRegionAsInput(m_featureRegionAsInputBuilder.build());
      }
    }
    if (m_featureRegionAsOutputSet) {
      _newInstance.setRegionAsOutput(m_regionAsOutput);
    } else {
      if (m_featureRegionAsOutputBuilder != null) {
        _newInstance.setRegionAsOutput(m_featureRegionAsOutputBuilder.build());
      }
    }
  ...
  public ExpansionNodeBuilder withActivity(org.eclipse.uml2.uml.Activity p_activity) {
    m_activity = p_activity;
    m_featureActivitySet = true;
    return this;
  }

  public ExpansionNodeBuilder withActivity(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.Activity> p_activityBuilder) {
    m_featureActivityBuilder = p_activityBuilder;
    return this;
  }

  public ExpansionNodeBuilder withInStructuredNode(org.eclipse.uml2.uml.StructuredActivityNode p_inStructuredNode) {
    m_inStructuredNode = p_inStructuredNode;
    m_featureInStructuredNodeSet = true;
    return this;
  }

  public ExpansionNodeBuilder withInStructuredNode(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.StructuredActivityNode> p_structuredActivityNodeBuilder) {
    m_featureInStructuredNodeBuilder = p_structuredActivityNodeBuilder;
    return this;
  }

  public ExpansionNodeBuilder withIsControlType(Boolean p_isControlType) {
    m_isControlType = p_isControlType;
    m_featureIsControlTypeSet = true;
    return this;
  }

  public ExpansionNodeBuilder withIsLeaf(Boolean p_isLeaf) {
    m_isLeaf = p_isLeaf;
    m_featureIsLeafSet = true;
    return this;
  }

  public ExpansionNodeBuilder withName(java.lang.String p_name) {
    m_name = p_name;
    m_featureNameSet = true;
    return this;
  }

  public ExpansionNodeBuilder withNameExpression(org.eclipse.uml2.uml.StringExpression p_nameExpression) {
    m_nameExpression = p_nameExpression;
    m_featureNameExpressionSet = true;
    return this;
  }

  public ExpansionNodeBuilder withNameExpression(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.StringExpression> p_stringExpressionBuilder) {
    m_featureNameExpressionBuilder = p_stringExpressionBuilder;
    return this;
  }

  public ExpansionNodeBuilder withOrdering(org.eclipse.uml2.uml.ObjectNodeOrderingKind p_ordering) {
    m_ordering = p_ordering;
    m_featureOrderingSet = true;
    return this;
  }

  public ExpansionNodeBuilder withRegionAsInput(org.eclipse.uml2.uml.ExpansionRegion p_regionAsInput) {
    m_regionAsInput = p_regionAsInput;
    m_featureRegionAsInputSet = true;
    return this;
  }

  public ExpansionNodeBuilder withRegionAsInput(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.ExpansionRegion> p_expansionRegionBuilder) {
    m_featureRegionAsInputBuilder = p_expansionRegionBuilder;
    return this;
  }

  public ExpansionNodeBuilder withRegionAsOutput(org.eclipse.uml2.uml.ExpansionRegion p_regionAsOutput) {
    m_regionAsOutput = p_regionAsOutput;
    m_featureRegionAsOutputSet = true;
    return this;
  }

  public ExpansionNodeBuilder withRegionAsOutput(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.ExpansionRegion> p_expansionRegionBuilder) {
    m_featureRegionAsOutputBuilder = p_expansionRegionBuilder;
    return this;
  }

  public ExpansionNodeBuilder withSelection(org.eclipse.uml2.uml.Behavior p_selection) {
    m_selection = p_selection;
    m_featureSelectionSet = true;
    return this;
  }

  public ExpansionNodeBuilder withSelection(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.Behavior> p_behaviorBuilder) {
    m_featureSelectionBuilder = p_behaviorBuilder;
    return this;
  }

  public ExpansionNodeBuilder withType(org.eclipse.uml2.uml.Type p_type) {
    m_type = p_type;
    m_featureTypeSet = true;
    return this;
  }

  public ExpansionNodeBuilder withType(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.Type> p_typeBuilder) {
    m_featureTypeBuilder = p_typeBuilder;
    return this;
  }

  public ExpansionNodeBuilder withUpperBound(org.eclipse.uml2.uml.ValueSpecification p_upperBound) {
    m_upperBound = p_upperBound;
    m_featureUpperBoundSet = true;
    return this;
  }

  public ExpansionNodeBuilder withUpperBound(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.ValueSpecification> p_valueSpecificationBuilder) {
    m_featureUpperBoundBuilder = p_valueSpecificationBuilder;
    return this;
  }

  public ExpansionNodeBuilder withVisibility(org.eclipse.uml2.uml.VisibilityKind p_visibility) {
    m_visibility = p_visibility;
    m_featureVisibilitySet = true;
    return this;
  }

  public ExpansionNodeBuilder withClientDependency(org.eclipse.uml2.uml.Dependency p_clientDependency) {
    m_clientDependency.add(p_clientDependency);
    m_featureClientDependencySet = true;
    return this;
  }

  public ExpansionNodeBuilder withClientDependency(java.util.Collection<? extends org.eclipse.uml2.uml.Dependency> p_clientDependency) {
    m_clientDependency.addAll(p_clientDependency);
    m_featureClientDependencySet = true;
    return this;
  }

  public ExpansionNodeBuilder withClientDependency(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.Dependency> p_dependencyBuilder) {
    m_featureClientDependencyBuilder.add(p_dependencyBuilder);
    return this;
  }

  public ExpansionNodeBuilder withEAnnotations(org.eclipse.emf.ecore.EAnnotation p_eAnnotations) {
    m_eAnnotations.add(p_eAnnotations);
    m_featureEAnnotationsSet = true;
    return this;
  }

  public ExpansionNodeBuilder withEAnnotations(java.util.Collection<? extends org.eclipse.emf.ecore.EAnnotation> p_eAnnotations) {
    m_eAnnotations.addAll(p_eAnnotations);
    m_featureEAnnotationsSet = true;
    return this;
  }

  public ExpansionNodeBuilder withEAnnotations(org.eclipse.emf.ecore.util.builder.IEcoreBuilder<? extends org.eclipse.emf.ecore.EAnnotation> p_eAnnotationBuilder) {
    m_featureEAnnotationsBuilder.add(p_eAnnotationBuilder);
    return this;
  }

  public ExpansionNodeBuilder withInInterruptibleRegion(org.eclipse.uml2.uml.InterruptibleActivityRegion p_inInterruptibleRegion) {
    m_inInterruptibleRegion.add(p_inInterruptibleRegion);
    m_featureInInterruptibleRegionSet = true;
    return this;
  }

  public ExpansionNodeBuilder withInInterruptibleRegion(java.util.Collection<? extends org.eclipse.uml2.uml.InterruptibleActivityRegion> p_inInterruptibleRegion) {
    m_inInterruptibleRegion.addAll(p_inInterruptibleRegion);
    m_featureInInterruptibleRegionSet = true;
    return this;
  }

  public ExpansionNodeBuilder withInInterruptibleRegion(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.InterruptibleActivityRegion> p_interruptibleActivityRegionBuilder) {
    m_featureInInterruptibleRegionBuilder.add(p_interruptibleActivityRegionBuilder);
    return this;
  }

  public ExpansionNodeBuilder withInPartition(org.eclipse.uml2.uml.ActivityPartition p_inPartition) {
    m_inPartition.add(p_inPartition);
    m_featureInPartitionSet = true;
    return this;
  }

  public ExpansionNodeBuilder withInPartition(java.util.Collection<? extends org.eclipse.uml2.uml.ActivityPartition> p_inPartition) {
    m_inPartition.addAll(p_inPartition);
    m_featureInPartitionSet = true;
    return this;
  }

  public ExpansionNodeBuilder withInPartition(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.ActivityPartition> p_activityPartitionBuilder) {
    m_featureInPartitionBuilder.add(p_activityPartitionBuilder);
    return this;
  }

  public ExpansionNodeBuilder withInState(org.eclipse.uml2.uml.State p_inState) {
    m_inState.add(p_inState);
    m_featureInStateSet = true;
    return this;
  }

  public ExpansionNodeBuilder withInState(java.util.Collection<? extends org.eclipse.uml2.uml.State> p_inState) {
    m_inState.addAll(p_inState);
    m_featureInStateSet = true;
    return this;
  }

  public ExpansionNodeBuilder withInState(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.State> p_stateBuilder) {
    m_featureInStateBuilder.add(p_stateBuilder);
    return this;
  }

  public ExpansionNodeBuilder withIncoming(org.eclipse.uml2.uml.ActivityEdge p_incoming) {
    m_incoming.add(p_incoming);
    m_featureIncomingSet = true;
    return this;
  }

  public ExpansionNodeBuilder withIncoming(java.util.Collection<? extends org.eclipse.uml2.uml.ActivityEdge> p_incoming) {
    m_incoming.addAll(p_incoming);
    m_featureIncomingSet = true;
    return this;
  }

  public ExpansionNodeBuilder withIncoming(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.ActivityEdge> p_activityEdgeBuilder) {
    m_featureIncomingBuilder.add(p_activityEdgeBuilder);
    return this;
  }

  public ExpansionNodeBuilder withOutgoing(org.eclipse.uml2.uml.ActivityEdge p_outgoing) {
    m_outgoing.add(p_outgoing);
    m_featureOutgoingSet = true;
    return this;
  }

  public ExpansionNodeBuilder withOutgoing(java.util.Collection<? extends org.eclipse.uml2.uml.ActivityEdge> p_outgoing) {
    m_outgoing.addAll(p_outgoing);
    m_featureOutgoingSet = true;
    return this;
  }

  public ExpansionNodeBuilder withOutgoing(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.ActivityEdge> p_activityEdgeBuilder) {
    m_featureOutgoingBuilder.add(p_activityEdgeBuilder);
    return this;
  }

  public ExpansionNodeBuilder withOwnedComment(org.eclipse.uml2.uml.Comment p_ownedComment) {
    m_ownedComment.add(p_ownedComment);
    m_featureOwnedCommentSet = true;
    return this;
  }

  public ExpansionNodeBuilder withOwnedComment(java.util.Collection<? extends org.eclipse.uml2.uml.Comment> p_ownedComment) {
    m_ownedComment.addAll(p_ownedComment);
    m_featureOwnedCommentSet = true;
    return this;
  }

  public ExpansionNodeBuilder withOwnedComment(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.Comment> p_commentBuilder) {
    m_featureOwnedCommentBuilder.add(p_commentBuilder);
    return this;
  }

  public ExpansionNodeBuilder withRedefinedNode(org.eclipse.uml2.uml.ActivityNode p_redefinedNode) {
    m_redefinedNode.add(p_redefinedNode);
    m_featureRedefinedNodeSet = true;
    return this;
  }

  public ExpansionNodeBuilder withRedefinedNode(java.util.Collection<? extends org.eclipse.uml2.uml.ActivityNode> p_redefinedNode) {
    m_redefinedNode.addAll(p_redefinedNode);
    m_featureRedefinedNodeSet = true;
    return this;
  }

  public ExpansionNodeBuilder withRedefinedNode(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.ActivityNode> p_activityNodeBuilder) {
