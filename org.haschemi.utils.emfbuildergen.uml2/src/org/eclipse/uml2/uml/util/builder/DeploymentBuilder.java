 ...
 * @generated
 */
public class DeploymentBuilder implements org.eclipse.uml2.uml.util.builder.IUmlBuilder<org.eclipse.uml2.uml.Deployment> {
  // features and builders
  private org.eclipse.uml2.uml.DeploymentTarget m_location;
  private org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.DeploymentTarget> m_featureLocationBuilder;
  ...
  private java.util.Collection<org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.DeploymentSpecification>> m_featureConfigurationBuilder = new java.util.LinkedList<org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.DeploymentSpecification>>();
  ...
  private java.util.Collection<org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.DeployedArtifact>> m_featureDeployedArtifactBuilder = new java.util.LinkedList<org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.DeployedArtifact>>();
  ...
  public DeploymentBuilder but() {
    ...
    _builder.m_featureDeployedArtifactBuilder = m_featureDeployedArtifactBuilder;
    _builder.m_featureEAnnotationsSet = m_featureEAnnotationsSet;
    _builder.m_eAnnotations = m_eAnnotations;
    _builder.m_featureEAnnotationsBuilder = m_featureEAnnotationsBuilder;
    _builder.m_featureLocationSet = m_featureLocationSet;
    _builder.m_location = m_location;
    _builder.m_featureLocationBuilder = m_featureLocationBuilder;
  ...
  public org.eclipse.uml2.uml.Deployment build() {
    ...
    if (m_featureLocationSet) {
      ...
      if (m_featureLocationBuilder != null) {
        _newInstance.setLocation(m_featureLocationBuilder.build());
      }
    }
    if (m_featureNameSet) {
    ...
    if (m_featureConfigurationSet) {
      ...
      if (!m_featureConfigurationBuilder.isEmpty()) {
        for (org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.DeploymentSpecification> builder : m_featureConfigurationBuilder) {
    ...
    if (m_featureDeployedArtifactSet) {
      ...
      if (!m_featureDeployedArtifactBuilder.isEmpty()) {
        for (org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.DeployedArtifact> builder : m_featureDeployedArtifactBuilder) {
          _newInstance.getDeployedArtifacts().add(builder.build());
        }
      }
    }
  ...
  public DeploymentBuilder withLocation(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.DeploymentTarget> p_deploymentTargetBuilder) {
    m_featureLocationBuilder = p_deploymentTargetBuilder;
    return this;
  }
  ...
  public DeploymentBuilder withNameExpression(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.StringExpression> p_stringExpressionBuilder) {
  ...
  public DeploymentBuilder withOwningTemplateParameter(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.TemplateParameter> p_templateParameterBuilder) {
  ...
  public DeploymentBuilder withTemplateParameter(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.TemplateParameter> p_templateParameterBuilder) {
  ...
  public DeploymentBuilder withClient(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.NamedElement> p_namedElementBuilder) {
  ...
  public DeploymentBuilder withClientDependency(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.Dependency> p_dependencyBuilder) {
  ...
  public DeploymentBuilder withConfiguration(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.DeploymentSpecification> p_deploymentSpecificationBuilder) {
  ...
  public DeploymentBuilder withDeployedArtifact(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.DeployedArtifact> p_deployedArtifactBuilder) {
    m_featureDeployedArtifactBuilder.add(p_deployedArtifactBuilder);
    return this;
  }

  public DeploymentBuilder withEAnnotations(org.eclipse.emf.ecore.EAnnotation p_eAnnotations) {
    m_eAnnotations.add(p_eAnnotations);
    m_featureEAnnotationsSet = true;
    return this;
  }

  public DeploymentBuilder withEAnnotations(java.util.Collection<? extends org.eclipse.emf.ecore.EAnnotation> p_eAnnotations) {
    m_eAnnotations.addAll(p_eAnnotations);
    m_featureEAnnotationsSet = true;
    return this;
  }

  public DeploymentBuilder withEAnnotations(org.eclipse.emf.ecore.util.builder.IEcoreBuilder<? extends org.eclipse.emf.ecore.EAnnotation> p_eAnnotationBuilder) {
  ...
  public DeploymentBuilder withOwnedComment(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.Comment> p_commentBuilder) {
  ...
  public DeploymentBuilder withSupplier(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.NamedElement> p_namedElementBuilder) {
