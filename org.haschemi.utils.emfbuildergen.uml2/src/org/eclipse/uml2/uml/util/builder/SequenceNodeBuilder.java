...
public class SequenceNodeBuilder {
  ...
  public SequenceNodeBuilder withActivity(org.eclipse.uml2.uml.util.builder.ActivityBuilder p_activityBuilder) {
  ...
  public SequenceNodeBuilder withInActivity(org.eclipse.uml2.uml.util.builder.ActivityBuilder p_activityBuilder) {
  ...
  public SequenceNodeBuilder withInStructuredNode(org.eclipse.uml2.uml.util.builder.StructuredActivityNodeBuilder p_structuredActivityNodeBuilder) {
  ...
  public SequenceNodeBuilder withNameExpression(org.eclipse.uml2.uml.util.builder.StringExpressionBuilder p_stringExpressionBuilder) {
  ...
  public SequenceNodeBuilder withClientDependency(DependencyBuilder p_dependencyBuilder) {
  ...
  public SequenceNodeBuilder withElementImport(ElementImportBuilder p_elementImportBuilder) {
  ...
  public SequenceNodeBuilder withHandler(ExceptionHandlerBuilder p_exceptionHandlerBuilder) {
  ...
  public SequenceNodeBuilder withInInterruptibleRegion(InterruptibleActivityRegionBuilder p_interruptibleActivityRegionBuilder) {
  ...
  public SequenceNodeBuilder withInPartition(ActivityPartitionBuilder p_activityPartitionBuilder) {
  ...
  public SequenceNodeBuilder withLocalPostcondition(ConstraintBuilder p_constraintBuilder) {
  ...
  public SequenceNodeBuilder withLocalPrecondition(ConstraintBuilder p_constraintBuilder) {
  ...
  public SequenceNodeBuilder withOwnedComment(CommentBuilder p_commentBuilder) {
  ...
  public SequenceNodeBuilder withOwnedRule(ConstraintBuilder p_constraintBuilder) {
  ...
  public SequenceNodeBuilder withPackageImport(PackageImportBuilder p_packageImportBuilder) {
  ...
  public SequenceNodeBuilder withVariable(VariableBuilder p_variableBuilder) {
