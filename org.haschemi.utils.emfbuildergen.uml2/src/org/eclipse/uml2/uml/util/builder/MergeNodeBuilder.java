...
/**
 * <!-- begin-user-doc --> 
 *   A builder for the model object ' <em><b>org.eclipse.uml2.uml.MergeNode</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class MergeNodeBuilder implements org.eclipse.uml2.uml.util.builder.IUmlBuilder<org.eclipse.uml2.uml.MergeNode> {
   ...
   * @see #newMergeNodeBuilder()
   */
  private MergeNodeBuilder() {
  }

  /**
   * This method creates a new instance of the MergeNodeBuilder.
   * @return new instance of the MergeNodeBuilder
   */
  public static MergeNodeBuilder newMergeNodeBuilder() {
   ...
   */
  public MergeNodeBuilder but() {
    MergeNodeBuilder _builder = newMergeNodeBuilder();
  ...
  /**
   * This method constructs the final org.eclipse.uml2.uml.MergeNode type.
   * @return new instance of the org.eclipse.uml2.uml.MergeNode type
   */
  public org.eclipse.uml2.uml.MergeNode build() {
    final org.eclipse.uml2.uml.MergeNode _newInstance = org.eclipse.uml2.uml.UMLFactory.eINSTANCE.createMergeNode();
  ...
  public MergeNodeBuilder withActivity(org.eclipse.uml2.uml.Activity p_activity) {
  ...
  public MergeNodeBuilder withInStructuredNode(org.eclipse.uml2.uml.StructuredActivityNode p_inStructuredNode) {
  ...
  public MergeNodeBuilder withIsLeaf(Boolean p_isLeaf) {
    m_isLeaf = p_isLeaf;
    m_featureIsLeafSet = true;
    return this;
  }

  public MergeNodeBuilder withName(java.lang.String p_name) {
    m_name = p_name;
    m_featureNameSet = true;
    return this;
  }

  public MergeNodeBuilder withNameExpression(org.eclipse.uml2.uml.StringExpression p_nameExpression) {
  ...
  public MergeNodeBuilder withVisibility(org.eclipse.uml2.uml.VisibilityKind p_visibility) {
    m_visibility = p_visibility;
    m_featureVisibilitySet = true;
    return this;
  }

  public MergeNodeBuilder withClientDependency(org.eclipse.uml2.uml.Dependency p_clientDependency) {
    m_clientDependency.add(p_clientDependency);
    m_featureClientDependencySet = true;
    return this;
  }

  public MergeNodeBuilder withClientDependency(java.util.Collection<? extends org.eclipse.uml2.uml.Dependency> p_clientDependency) {
  ...
  public MergeNodeBuilder withInInterruptibleRegion(org.eclipse.uml2.uml.InterruptibleActivityRegion p_inInterruptibleRegion) {
    m_inInterruptibleRegion.add(p_inInterruptibleRegion);
    m_featureInInterruptibleRegionSet = true;
    return this;
  }

  public MergeNodeBuilder withInInterruptibleRegion(java.util.Collection<? extends org.eclipse.uml2.uml.InterruptibleActivityRegion> p_inInterruptibleRegion) {
  ...
  public MergeNodeBuilder withInPartition(org.eclipse.uml2.uml.ActivityPartition p_inPartition) {
    m_inPartition.add(p_inPartition);
    m_featureInPartitionSet = true;
    return this;
  }

  public MergeNodeBuilder withInPartition(java.util.Collection<? extends org.eclipse.uml2.uml.ActivityPartition> p_inPartition) {
  ...
  public MergeNodeBuilder withIncoming(org.eclipse.uml2.uml.ActivityEdge p_incoming) {
    m_incoming.add(p_incoming);
    m_featureIncomingSet = true;
    return this;
  }

  public MergeNodeBuilder withIncoming(java.util.Collection<? extends org.eclipse.uml2.uml.ActivityEdge> p_incoming) {
  ...
  public MergeNodeBuilder withOwnedComment(org.eclipse.uml2.uml.Comment p_ownedComment) {
    m_ownedComment.add(p_ownedComment);
    m_featureOwnedCommentSet = true;
    return this;
  }

  public MergeNodeBuilder withOwnedComment(java.util.Collection<? extends org.eclipse.uml2.uml.Comment> p_ownedComment) {
  ...
  public MergeNodeBuilder withRedefinedNode(org.eclipse.uml2.uml.ActivityNode p_redefinedNode) {
