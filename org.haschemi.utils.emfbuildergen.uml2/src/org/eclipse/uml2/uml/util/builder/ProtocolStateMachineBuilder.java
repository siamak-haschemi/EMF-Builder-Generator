 ...
 * @generated
 */
public class ProtocolStateMachineBuilder {
  ...
  private java.util.Collection<org.eclipse.uml2.uml.util.builder.ProtocolConformanceBuilder> m_featureConformanceBuilder = new java.util.LinkedList<org.eclipse.uml2.uml.util.builder.ProtocolConformanceBuilder>();
  ...
  private java.util.Collection<org.eclipse.uml2.uml.util.builder.StateMachineBuilder> m_featureExtendedStateMachineBuilder = new java.util.LinkedList<org.eclipse.uml2.uml.util.builder.StateMachineBuilder>();
  ...
  private java.util.Collection<org.eclipse.uml2.uml.util.builder.StateBuilder> m_featureSubmachineStateBuilder = new java.util.LinkedList<org.eclipse.uml2.uml.util.builder.StateBuilder>();
  ...
  public org.eclipse.uml2.uml.ProtocolStateMachine build() {
    ...
    if (m_featureConformanceSet) {
      ...
      if (!m_featureConformanceBuilder.isEmpty()) {
        for (ProtocolConformanceBuilder builder : m_featureConformanceBuilder) {
    ...
    if (m_featureExtendedStateMachineSet) {
      ...
      if (!m_featureExtendedStateMachineBuilder.isEmpty()) {
        for (StateMachineBuilder builder : m_featureExtendedStateMachineBuilder) {
    ...
    if (m_featureSubmachineStateSet) {
      ...
      if (!m_featureSubmachineStateBuilder.isEmpty()) {
        for (StateBuilder builder : m_featureSubmachineStateBuilder) {
  ...
  public ProtocolStateMachineBuilder withNameExpression(org.eclipse.uml2.uml.util.builder.StringExpressionBuilder p_stringExpressionBuilder) {
  ...
  public ProtocolStateMachineBuilder withOwnedTemplateSignature(org.eclipse.uml2.uml.util.builder.TemplateSignatureBuilder p_templateSignatureBuilder) {
  ...
  public ProtocolStateMachineBuilder withOwningTemplateParameter(org.eclipse.uml2.uml.util.builder.TemplateParameterBuilder p_templateParameterBuilder) {
  ...
  public ProtocolStateMachineBuilder withRepresentation(org.eclipse.uml2.uml.util.builder.CollaborationUseBuilder p_collaborationUseBuilder) {
  ...
  public ProtocolStateMachineBuilder withTemplateParameter(org.eclipse.uml2.uml.util.builder.TemplateParameterBuilder p_templateParameterBuilder) {
  ...
  public ProtocolStateMachineBuilder withClientDependency(DependencyBuilder p_dependencyBuilder) {
  ...
  public ProtocolStateMachineBuilder withCollaborationUse(CollaborationUseBuilder p_collaborationUseBuilder) {
  ...
  public ProtocolStateMachineBuilder withConformance(ProtocolConformanceBuilder p_protocolConformanceBuilder) {
  ...
  public ProtocolStateMachineBuilder withConnectionPoint(PseudostateBuilder p_pseudostateBuilder) {
  ...
  public ProtocolStateMachineBuilder withElementImport(ElementImportBuilder p_elementImportBuilder) {
  ...
  public ProtocolStateMachineBuilder withExtendedStateMachine(StateMachineBuilder p_stateMachineBuilder) {
  ...
  public ProtocolStateMachineBuilder withGeneralization(GeneralizationBuilder p_generalizationBuilder) {
  ...
  public ProtocolStateMachineBuilder withInterfaceRealization(InterfaceRealizationBuilder p_interfaceRealizationBuilder) {
  ...
  public ProtocolStateMachineBuilder withOwnedAttribute(PropertyBuilder p_propertyBuilder) {
  ...
  public ProtocolStateMachineBuilder withOwnedComment(CommentBuilder p_commentBuilder) {
  ...
  public ProtocolStateMachineBuilder withOwnedConnector(ConnectorBuilder p_connectorBuilder) {
  ...
  public ProtocolStateMachineBuilder withOwnedOperation(OperationBuilder p_operationBuilder) {
  ...
  public ProtocolStateMachineBuilder withOwnedParameter(ParameterBuilder p_parameterBuilder) {
  ...
  public ProtocolStateMachineBuilder withOwnedParameterSet(ParameterSetBuilder p_parameterSetBuilder) {
  ...
  public ProtocolStateMachineBuilder withOwnedReception(ReceptionBuilder p_receptionBuilder) {
  ...
  public ProtocolStateMachineBuilder withOwnedRule(ConstraintBuilder p_constraintBuilder) {
  ...
  public ProtocolStateMachineBuilder withOwnedTrigger(TriggerBuilder p_triggerBuilder) {
  ...
  public ProtocolStateMachineBuilder withOwnedUseCase(UseCaseBuilder p_useCaseBuilder) {
  ...
  public ProtocolStateMachineBuilder withPackageImport(PackageImportBuilder p_packageImportBuilder) {
  ...
  public ProtocolStateMachineBuilder withPostcondition(ConstraintBuilder p_constraintBuilder) {
  ...
  public ProtocolStateMachineBuilder withPowertypeExtent(GeneralizationSetBuilder p_generalizationSetBuilder) {
  ...
  public ProtocolStateMachineBuilder withPrecondition(ConstraintBuilder p_constraintBuilder) {
  ...
  public ProtocolStateMachineBuilder withRegion(RegionBuilder p_regionBuilder) {
  ...
  public ProtocolStateMachineBuilder withSubmachineState(StateBuilder p_stateBuilder) {
  ...
  public ProtocolStateMachineBuilder withSubstitution(SubstitutionBuilder p_substitutionBuilder) {
  ...
  public ProtocolStateMachineBuilder withTemplateBinding(TemplateBindingBuilder p_templateBindingBuilder) {
  ...
  public ProtocolStateMachineBuilder withUseCase(UseCaseBuilder p_useCaseBuilder) {
