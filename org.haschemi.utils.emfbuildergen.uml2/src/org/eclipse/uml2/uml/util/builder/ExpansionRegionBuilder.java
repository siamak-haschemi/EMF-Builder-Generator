 ...
 * @generated
 */
public class ExpansionRegionBuilder {
  ...
  private java.util.Collection<org.eclipse.uml2.uml.util.builder.ExpansionNodeBuilder> m_featureInputElementBuilder = new java.util.LinkedList<org.eclipse.uml2.uml.util.builder.ExpansionNodeBuilder>();
  ...
  private java.util.Collection<org.eclipse.uml2.uml.util.builder.ExpansionNodeBuilder> m_featureOutputElementBuilder = new java.util.LinkedList<org.eclipse.uml2.uml.util.builder.ExpansionNodeBuilder>();
  ...
  public org.eclipse.uml2.uml.ExpansionRegion build() {
    ...
    if (m_featureInputElementSet) {
      ...
      if (!m_featureInputElementBuilder.isEmpty()) {
        for (ExpansionNodeBuilder builder : m_featureInputElementBuilder) {
    ...
    if (m_featureOutputElementSet) {
      ...
      if (!m_featureOutputElementBuilder.isEmpty()) {
        for (ExpansionNodeBuilder builder : m_featureOutputElementBuilder) {
  ...
  public ExpansionRegionBuilder withActivity(org.eclipse.uml2.uml.util.builder.ActivityBuilder p_activityBuilder) {
  ...
  public ExpansionRegionBuilder withInActivity(org.eclipse.uml2.uml.util.builder.ActivityBuilder p_activityBuilder) {
  ...
  public ExpansionRegionBuilder withInStructuredNode(org.eclipse.uml2.uml.util.builder.StructuredActivityNodeBuilder p_structuredActivityNodeBuilder) {
  ...
  public ExpansionRegionBuilder withNameExpression(org.eclipse.uml2.uml.util.builder.StringExpressionBuilder p_stringExpressionBuilder) {
  ...
  public ExpansionRegionBuilder withClientDependency(DependencyBuilder p_dependencyBuilder) {
  ...
  public ExpansionRegionBuilder withElementImport(ElementImportBuilder p_elementImportBuilder) {
  ...
  public ExpansionRegionBuilder withHandler(ExceptionHandlerBuilder p_exceptionHandlerBuilder) {
  ...
  public ExpansionRegionBuilder withInInterruptibleRegion(InterruptibleActivityRegionBuilder p_interruptibleActivityRegionBuilder) {
  ...
  public ExpansionRegionBuilder withInPartition(ActivityPartitionBuilder p_activityPartitionBuilder) {
  ...
  public ExpansionRegionBuilder withInputElement(ExpansionNodeBuilder p_expansionNodeBuilder) {
  ...
  public ExpansionRegionBuilder withLocalPostcondition(ConstraintBuilder p_constraintBuilder) {
  ...
  public ExpansionRegionBuilder withLocalPrecondition(ConstraintBuilder p_constraintBuilder) {
  ...
  public ExpansionRegionBuilder withOutputElement(ExpansionNodeBuilder p_expansionNodeBuilder) {
  ...
  public ExpansionRegionBuilder withOwnedComment(CommentBuilder p_commentBuilder) {
  ...
  public ExpansionRegionBuilder withOwnedRule(ConstraintBuilder p_constraintBuilder) {
  ...
  public ExpansionRegionBuilder withPackageImport(PackageImportBuilder p_packageImportBuilder) {
  ...
  public ExpansionRegionBuilder withVariable(VariableBuilder p_variableBuilder) {
