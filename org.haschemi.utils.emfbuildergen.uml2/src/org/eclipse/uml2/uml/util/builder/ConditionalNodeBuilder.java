 ...
 * @generated
 */
public class ConditionalNodeBuilder {
  ...
  private java.util.Collection<org.eclipse.uml2.uml.util.builder.ClauseBuilder> m_featureClauseBuilder = new java.util.LinkedList<org.eclipse.uml2.uml.util.builder.ClauseBuilder>();
  ...
  public org.eclipse.uml2.uml.ConditionalNode build() {
    ...
    if (m_featureClauseSet) {
      ...
      if (!m_featureClauseBuilder.isEmpty()) {
        for (ClauseBuilder builder : m_featureClauseBuilder) {
  ...
  public ConditionalNodeBuilder withActivity(org.eclipse.uml2.uml.util.builder.ActivityBuilder p_activityBuilder) {
  ...
  public ConditionalNodeBuilder withInActivity(org.eclipse.uml2.uml.util.builder.ActivityBuilder p_activityBuilder) {
  ...
  public ConditionalNodeBuilder withInStructuredNode(org.eclipse.uml2.uml.util.builder.StructuredActivityNodeBuilder p_structuredActivityNodeBuilder) {
  ...
  public ConditionalNodeBuilder withNameExpression(org.eclipse.uml2.uml.util.builder.StringExpressionBuilder p_stringExpressionBuilder) {
  ...
  public ConditionalNodeBuilder withClause(ClauseBuilder p_clauseBuilder) {
  ...
  public ConditionalNodeBuilder withClientDependency(DependencyBuilder p_dependencyBuilder) {
  ...
  public ConditionalNodeBuilder withElementImport(ElementImportBuilder p_elementImportBuilder) {
  ...
  public ConditionalNodeBuilder withHandler(ExceptionHandlerBuilder p_exceptionHandlerBuilder) {
  ...
  public ConditionalNodeBuilder withInInterruptibleRegion(InterruptibleActivityRegionBuilder p_interruptibleActivityRegionBuilder) {
  ...
  public ConditionalNodeBuilder withInPartition(ActivityPartitionBuilder p_activityPartitionBuilder) {
  ...
  public ConditionalNodeBuilder withLocalPostcondition(ConstraintBuilder p_constraintBuilder) {
  ...
  public ConditionalNodeBuilder withLocalPrecondition(ConstraintBuilder p_constraintBuilder) {
  ...
  public ConditionalNodeBuilder withOwnedComment(CommentBuilder p_commentBuilder) {
  ...
  public ConditionalNodeBuilder withOwnedRule(ConstraintBuilder p_constraintBuilder) {
  ...
  public ConditionalNodeBuilder withPackageImport(PackageImportBuilder p_packageImportBuilder) {
  ...
  public ConditionalNodeBuilder withResult(OutputPinBuilder p_outputPinBuilder) {
  ...
  public ConditionalNodeBuilder withVariable(VariableBuilder p_variableBuilder) {
