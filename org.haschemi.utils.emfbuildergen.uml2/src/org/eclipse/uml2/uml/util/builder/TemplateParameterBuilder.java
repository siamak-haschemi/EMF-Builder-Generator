...
/**
 * <!-- begin-user-doc --> 
 *   A builder for the model object ' <em><b>org.eclipse.uml2.uml.TemplateParameter</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class TemplateParameterBuilder implements org.eclipse.uml2.uml.util.builder.IUmlBuilder<org.eclipse.uml2.uml.TemplateParameter> {
   ...
   * @see #newTemplateParameterBuilder()
   */
  private TemplateParameterBuilder() {
  }

  /**
   * This method creates a new instance of the TemplateParameterBuilder.
   * @return new instance of the TemplateParameterBuilder
   */
  public static TemplateParameterBuilder newTemplateParameterBuilder() {
   ...
   */
  public TemplateParameterBuilder but() {
    TemplateParameterBuilder _builder = newTemplateParameterBuilder();
  ...
  /**
   * This method constructs the final org.eclipse.uml2.uml.TemplateParameter type.
   * @return new instance of the org.eclipse.uml2.uml.TemplateParameter type
   */
  public org.eclipse.uml2.uml.TemplateParameter build() {
    final org.eclipse.uml2.uml.TemplateParameter _newInstance = org.eclipse.uml2.uml.UMLFactory.eINSTANCE.createTemplateParameter();
  ...
  public TemplateParameterBuilder withDefault_(org.eclipse.uml2.uml.ParameterableElement p_default_) {
    m_default_ = p_default_;
    m_featureDefault_Set = true;
    return this;
  }

  public TemplateParameterBuilder withDefault_(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.ParameterableElement> p_parameterableElementBuilder) {
    m_featureDefault_Builder = p_parameterableElementBuilder;
    return this;
  }

  public TemplateParameterBuilder withOwnedDefault(org.eclipse.uml2.uml.ParameterableElement p_ownedDefault) {
    m_ownedDefault = p_ownedDefault;
    m_featureOwnedDefaultSet = true;
    return this;
  }

  public TemplateParameterBuilder withOwnedDefault(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.ParameterableElement> p_parameterableElementBuilder) {
    m_featureOwnedDefaultBuilder = p_parameterableElementBuilder;
    return this;
  }

  public TemplateParameterBuilder withOwnedParameteredElement(org.eclipse.uml2.uml.ParameterableElement p_ownedParameteredElement) {
    m_ownedParameteredElement = p_ownedParameteredElement;
    m_featureOwnedParameteredElementSet = true;
    return this;
  }

  public TemplateParameterBuilder withOwnedParameteredElement(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.ParameterableElement> p_parameterableElementBuilder) {
    m_featureOwnedParameteredElementBuilder = p_parameterableElementBuilder;
    return this;
  }

  public TemplateParameterBuilder withParameteredElement(org.eclipse.uml2.uml.ParameterableElement p_parameteredElement) {
    m_parameteredElement = p_parameteredElement;
    m_featureParameteredElementSet = true;
    return this;
  }

  public TemplateParameterBuilder withParameteredElement(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.ParameterableElement> p_parameterableElementBuilder) {
    m_featureParameteredElementBuilder = p_parameterableElementBuilder;
    return this;
  }

  public TemplateParameterBuilder withSignature(org.eclipse.uml2.uml.TemplateSignature p_signature) {
    m_signature = p_signature;
    m_featureSignatureSet = true;
    return this;
  }

  public TemplateParameterBuilder withSignature(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.TemplateSignature> p_templateSignatureBuilder) {
    m_featureSignatureBuilder = p_templateSignatureBuilder;
    return this;
  }

  public TemplateParameterBuilder withEAnnotations(org.eclipse.emf.ecore.EAnnotation p_eAnnotations) {
    m_eAnnotations.add(p_eAnnotations);
    m_featureEAnnotationsSet = true;
    return this;
  }

  public TemplateParameterBuilder withEAnnotations(java.util.Collection<? extends org.eclipse.emf.ecore.EAnnotation> p_eAnnotations) {
    m_eAnnotations.addAll(p_eAnnotations);
    m_featureEAnnotationsSet = true;
    return this;
  }

  public TemplateParameterBuilder withEAnnotations(org.eclipse.emf.ecore.util.builder.IEcoreBuilder<? extends org.eclipse.emf.ecore.EAnnotation> p_eAnnotationBuilder) {
    m_featureEAnnotationsBuilder.add(p_eAnnotationBuilder);
    return this;
  }

  public TemplateParameterBuilder withOwnedComment(org.eclipse.uml2.uml.Comment p_ownedComment) {
    m_ownedComment.add(p_ownedComment);
    m_featureOwnedCommentSet = true;
    return this;
  }

  public TemplateParameterBuilder withOwnedComment(java.util.Collection<? extends org.eclipse.uml2.uml.Comment> p_ownedComment) {
    m_ownedComment.addAll(p_ownedComment);
    m_featureOwnedCommentSet = true;
    return this;
  }

  public TemplateParameterBuilder withOwnedComment(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.Comment> p_commentBuilder) {
