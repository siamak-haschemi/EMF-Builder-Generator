...
/**
 * <!-- begin-user-doc --> 
 *   A builder for the model object ' <em><b>org.eclipse.uml2.uml.Transition</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class TransitionBuilder implements org.eclipse.uml2.uml.util.builder.IUmlBuilder<org.eclipse.uml2.uml.Transition> {
   ...
   * @see #newTransitionBuilder()
   */
  private TransitionBuilder() {
  }

  /**
   * This method creates a new instance of the TransitionBuilder.
   * @return new instance of the TransitionBuilder
   */
  public static TransitionBuilder newTransitionBuilder() {
   ...
   */
  public TransitionBuilder but() {
    TransitionBuilder _builder = newTransitionBuilder();
  ...
  /**
   * This method constructs the final org.eclipse.uml2.uml.Transition type.
   * @return new instance of the org.eclipse.uml2.uml.Transition type
   */
  public org.eclipse.uml2.uml.Transition build() {
    final org.eclipse.uml2.uml.Transition _newInstance = org.eclipse.uml2.uml.UMLFactory.eINSTANCE.createTransition();
  ...
  public TransitionBuilder withContainer(org.eclipse.uml2.uml.Region p_container) {
    m_container = p_container;
    m_featureContainerSet = true;
    return this;
  }

  public TransitionBuilder withContainer(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.Region> p_regionBuilder) {
    m_featureContainerBuilder = p_regionBuilder;
    return this;
  }

  public TransitionBuilder withEffect(org.eclipse.uml2.uml.Behavior p_effect) {
    m_effect = p_effect;
    m_featureEffectSet = true;
    return this;
  }

  public TransitionBuilder withEffect(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.Behavior> p_behaviorBuilder) {
    m_featureEffectBuilder = p_behaviorBuilder;
    return this;
  }

  public TransitionBuilder withGuard(org.eclipse.uml2.uml.Constraint p_guard) {
    m_guard = p_guard;
    m_featureGuardSet = true;
    return this;
  }

  public TransitionBuilder withGuard(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.Constraint> p_constraintBuilder) {
    m_featureGuardBuilder = p_constraintBuilder;
    return this;
  }

  public TransitionBuilder withIsLeaf(Boolean p_isLeaf) {
    m_isLeaf = p_isLeaf;
    m_featureIsLeafSet = true;
    return this;
  }

  public TransitionBuilder withKind(org.eclipse.uml2.uml.TransitionKind p_kind) {
    m_kind = p_kind;
    m_featureKindSet = true;
    return this;
  }

  public TransitionBuilder withName(java.lang.String p_name) {
    m_name = p_name;
    m_featureNameSet = true;
    return this;
  }

  public TransitionBuilder withNameExpression(org.eclipse.uml2.uml.StringExpression p_nameExpression) {
    m_nameExpression = p_nameExpression;
    m_featureNameExpressionSet = true;
    return this;
  }

  public TransitionBuilder withNameExpression(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.StringExpression> p_stringExpressionBuilder) {
    m_featureNameExpressionBuilder = p_stringExpressionBuilder;
    return this;
  }

  public TransitionBuilder withRedefinedTransition(org.eclipse.uml2.uml.Transition p_redefinedTransition) {
    m_redefinedTransition = p_redefinedTransition;
    m_featureRedefinedTransitionSet = true;
    return this;
  }

  public TransitionBuilder withRedefinedTransition(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.Transition> p_transitionBuilder) {
    m_featureRedefinedTransitionBuilder = p_transitionBuilder;
    return this;
  }

  public TransitionBuilder withSource(org.eclipse.uml2.uml.Vertex p_source) {
    m_source = p_source;
    m_featureSourceSet = true;
    return this;
  }

  public TransitionBuilder withSource(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.Vertex> p_vertexBuilder) {
    m_featureSourceBuilder = p_vertexBuilder;
    return this;
  }

  public TransitionBuilder withTarget(org.eclipse.uml2.uml.Vertex p_target) {
    m_target = p_target;
    m_featureTargetSet = true;
    return this;
  }

  public TransitionBuilder withTarget(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.Vertex> p_vertexBuilder) {
    m_featureTargetBuilder = p_vertexBuilder;
    return this;
  }

  public TransitionBuilder withVisibility(org.eclipse.uml2.uml.VisibilityKind p_visibility) {
    m_visibility = p_visibility;
    m_featureVisibilitySet = true;
    return this;
  }

  public TransitionBuilder withClientDependency(org.eclipse.uml2.uml.Dependency p_clientDependency) {
    m_clientDependency.add(p_clientDependency);
    m_featureClientDependencySet = true;
    return this;
  }

  public TransitionBuilder withClientDependency(java.util.Collection<? extends org.eclipse.uml2.uml.Dependency> p_clientDependency) {
    m_clientDependency.addAll(p_clientDependency);
    m_featureClientDependencySet = true;
    return this;
  }

  public TransitionBuilder withClientDependency(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.Dependency> p_dependencyBuilder) {
    m_featureClientDependencyBuilder.add(p_dependencyBuilder);
    return this;
  }

  public TransitionBuilder withEAnnotations(org.eclipse.emf.ecore.EAnnotation p_eAnnotations) {
    m_eAnnotations.add(p_eAnnotations);
    m_featureEAnnotationsSet = true;
    return this;
  }

  public TransitionBuilder withEAnnotations(java.util.Collection<? extends org.eclipse.emf.ecore.EAnnotation> p_eAnnotations) {
    m_eAnnotations.addAll(p_eAnnotations);
    m_featureEAnnotationsSet = true;
    return this;
  }

  public TransitionBuilder withEAnnotations(org.eclipse.emf.ecore.util.builder.IEcoreBuilder<? extends org.eclipse.emf.ecore.EAnnotation> p_eAnnotationBuilder) {
    m_featureEAnnotationsBuilder.add(p_eAnnotationBuilder);
    return this;
  }

  public TransitionBuilder withElementImport(org.eclipse.uml2.uml.ElementImport p_elementImport) {
    m_elementImport.add(p_elementImport);
    m_featureElementImportSet = true;
    return this;
  }

  public TransitionBuilder withElementImport(java.util.Collection<? extends org.eclipse.uml2.uml.ElementImport> p_elementImport) {
    m_elementImport.addAll(p_elementImport);
    m_featureElementImportSet = true;
    return this;
  }

  public TransitionBuilder withElementImport(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.ElementImport> p_elementImportBuilder) {
    m_featureElementImportBuilder.add(p_elementImportBuilder);
    return this;
  }

  public TransitionBuilder withOwnedComment(org.eclipse.uml2.uml.Comment p_ownedComment) {
    m_ownedComment.add(p_ownedComment);
    m_featureOwnedCommentSet = true;
    return this;
  }

  public TransitionBuilder withOwnedComment(java.util.Collection<? extends org.eclipse.uml2.uml.Comment> p_ownedComment) {
    m_ownedComment.addAll(p_ownedComment);
    m_featureOwnedCommentSet = true;
    return this;
  }

  public TransitionBuilder withOwnedComment(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.Comment> p_commentBuilder) {
    m_featureOwnedCommentBuilder.add(p_commentBuilder);
    return this;
  }

  public TransitionBuilder withOwnedRule(org.eclipse.uml2.uml.Constraint p_ownedRule) {
    m_ownedRule.add(p_ownedRule);
    m_featureOwnedRuleSet = true;
    return this;
  }

  public TransitionBuilder withOwnedRule(java.util.Collection<? extends org.eclipse.uml2.uml.Constraint> p_ownedRule) {
    m_ownedRule.addAll(p_ownedRule);
    m_featureOwnedRuleSet = true;
    return this;
  }

  public TransitionBuilder withOwnedRule(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.Constraint> p_constraintBuilder) {
    m_featureOwnedRuleBuilder.add(p_constraintBuilder);
    return this;
  }

  public TransitionBuilder withPackageImport(org.eclipse.uml2.uml.PackageImport p_packageImport) {
    m_packageImport.add(p_packageImport);
    m_featurePackageImportSet = true;
    return this;
  }

  public TransitionBuilder withPackageImport(java.util.Collection<? extends org.eclipse.uml2.uml.PackageImport> p_packageImport) {
    m_packageImport.addAll(p_packageImport);
    m_featurePackageImportSet = true;
    return this;
  }

  public TransitionBuilder withPackageImport(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.PackageImport> p_packageImportBuilder) {
    m_featurePackageImportBuilder.add(p_packageImportBuilder);
    return this;
  }

  public TransitionBuilder withTrigger(org.eclipse.uml2.uml.Trigger p_trigger) {
    m_trigger.add(p_trigger);
    m_featureTriggerSet = true;
    return this;
  }

  public TransitionBuilder withTrigger(java.util.Collection<? extends org.eclipse.uml2.uml.Trigger> p_trigger) {
    m_trigger.addAll(p_trigger);
    m_featureTriggerSet = true;
    return this;
  }

  public TransitionBuilder withTrigger(org.eclipse.uml2.uml.util.builder.IUmlBuilder<? extends org.eclipse.uml2.uml.Trigger> p_triggerBuilder) {
