...
/**
 * <!-- begin-user-doc --> 
 *   A builder for the model object ' <em><b>org.eclipse.uml2.uml.ExecutionOccurrenceSpecification</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class ExecutionOccurrenceSpecificationBuilder implements org.eclipse.uml2.uml.util.builder.IUmlBuilder<org.eclipse.uml2.uml.ExecutionOccurrenceSpecification> {
  ...
  private boolean m_featureExecutionSet = false;
   ...
   * @see #newExecutionOccurrenceSpecificationBuilder()
   */
  private ExecutionOccurrenceSpecificationBuilder() {
  }

  /**
   * This method creates a new instance of the ExecutionOccurrenceSpecificationBuilder.
   * @return new instance of the ExecutionOccurrenceSpecificationBuilder
   */
  public static ExecutionOccurrenceSpecificationBuilder newExecutionOccurrenceSpecificationBuilder() {
    return new ExecutionOccurrenceSpecificationBuilder();
  }

  /**
   * This method can be used to override attributes of the builder. It constructs a new builder and copies the current values to it.
   */
  public ExecutionOccurrenceSpecificationBuilder but() {
    ExecutionOccurrenceSpecificationBuilder _builder = newExecutionOccurrenceSpecificationBuilder();
  ...
  /**
   * This method constructs the final org.eclipse.uml2.uml.ExecutionOccurrenceSpecification type.
   * @return new instance of the org.eclipse.uml2.uml.ExecutionOccurrenceSpecification type
   */
  public org.eclipse.uml2.uml.ExecutionOccurrenceSpecification build() {
    final org.eclipse.uml2.uml.ExecutionOccurrenceSpecification _newInstance = org.eclipse.uml2.uml.UMLFactory.eINSTANCE.createExecutionOccurrenceSpecification();
  ...
  public ExecutionOccurrenceSpecificationBuilder withEnclosingInteraction(org.eclipse.uml2.uml.Interaction p_enclosingInteraction) {
  ...
  public ExecutionOccurrenceSpecificationBuilder withEnclosingOperand(org.eclipse.uml2.uml.InteractionOperand p_enclosingOperand) {
  ...
  public ExecutionOccurrenceSpecificationBuilder withEvent(org.eclipse.uml2.uml.Event p_event) {
    m_event = p_event;
  ...
  public ExecutionOccurrenceSpecificationBuilder withName(java.lang.String p_name) {
    m_name = p_name;
    m_featureNameSet = true;
    return this;
  }

  public ExecutionOccurrenceSpecificationBuilder withNameExpression(org.eclipse.uml2.uml.StringExpression p_nameExpression) {
  ...
  public ExecutionOccurrenceSpecificationBuilder withVisibility(org.eclipse.uml2.uml.VisibilityKind p_visibility) {
    m_visibility = p_visibility;
    m_featureVisibilitySet = true;
    return this;
  }

  public ExecutionOccurrenceSpecificationBuilder withClientDependency(org.eclipse.uml2.uml.Dependency p_clientDependency) {
    m_clientDependency.add(p_clientDependency);
    m_featureClientDependencySet = true;
    return this;
  }

  public ExecutionOccurrenceSpecificationBuilder withClientDependency(java.util.Collection<? extends org.eclipse.uml2.uml.Dependency> p_clientDependency) {
  ...
  public ExecutionOccurrenceSpecificationBuilder withCovered(org.eclipse.uml2.uml.Lifeline p_covered) {
    m_covered.add(p_covered);
    m_featureCoveredSet = true;
    return this;
  }

  public ExecutionOccurrenceSpecificationBuilder withCovered(java.util.Collection<? extends org.eclipse.uml2.uml.Lifeline> p_covered) {
  ...
  public ExecutionOccurrenceSpecificationBuilder withGeneralOrdering(org.eclipse.uml2.uml.GeneralOrdering p_generalOrdering) {
    m_generalOrdering.add(p_generalOrdering);
    m_featureGeneralOrderingSet = true;
    return this;
  }

  public ExecutionOccurrenceSpecificationBuilder withGeneralOrdering(java.util.Collection<? extends org.eclipse.uml2.uml.GeneralOrdering> p_generalOrdering) {
  ...
  public ExecutionOccurrenceSpecificationBuilder withOwnedComment(org.eclipse.uml2.uml.Comment p_ownedComment) {
    m_ownedComment.add(p_ownedComment);
    m_featureOwnedCommentSet = true;
    return this;
  }

  public ExecutionOccurrenceSpecificationBuilder withOwnedComment(java.util.Collection<? extends org.eclipse.uml2.uml.Comment> p_ownedComment) {
  ...
  public ExecutionOccurrenceSpecificationBuilder withToAfter(org.eclipse.uml2.uml.GeneralOrdering p_toAfter) {
    m_toAfter.add(p_toAfter);
    m_featureToAfterSet = true;
    return this;
  }

  public ExecutionOccurrenceSpecificationBuilder withToAfter(java.util.Collection<? extends org.eclipse.uml2.uml.GeneralOrdering> p_toAfter) {
  ...
  public ExecutionOccurrenceSpecificationBuilder withToBefore(org.eclipse.uml2.uml.GeneralOrdering p_toBefore) {
    m_toBefore.add(p_toBefore);
    m_featureToBeforeSet = true;
    return this;
  }

  public ExecutionOccurrenceSpecificationBuilder withToBefore(java.util.Collection<? extends org.eclipse.uml2.uml.GeneralOrdering> p_toBefore) {
