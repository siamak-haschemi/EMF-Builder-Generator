...
/**
 * <!-- begin-user-doc --> 
 *   A builder for the model object ' <em><b>org.eclipse.uml2.uml.OpaqueAction</b></em>'.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class OpaqueActionBuilder implements org.eclipse.uml2.uml.util.builder.IUmlBuilder<org.eclipse.uml2.uml.OpaqueAction> {
  ...
  private boolean m_featureOutputValueSet = false;
   ...
   * @see #newOpaqueActionBuilder()
   */
  private OpaqueActionBuilder() {
  }

  /**
   * This method creates a new instance of the OpaqueActionBuilder.
   * @return new instance of the OpaqueActionBuilder
   */
  public static OpaqueActionBuilder newOpaqueActionBuilder() {
    return new OpaqueActionBuilder();
  }

  /**
   * This method can be used to override attributes of the builder. It constructs a new builder and copies the current values to it.
   */
  public OpaqueActionBuilder but() {
    OpaqueActionBuilder _builder = newOpaqueActionBuilder();
  ...
  /**
   * This method constructs the final org.eclipse.uml2.uml.OpaqueAction type.
   * @return new instance of the org.eclipse.uml2.uml.OpaqueAction type
   */
  public org.eclipse.uml2.uml.OpaqueAction build() {
    final org.eclipse.uml2.uml.OpaqueAction _newInstance = org.eclipse.uml2.uml.UMLFactory.eINSTANCE.createOpaqueAction();
  ...
  public OpaqueActionBuilder withActivity(org.eclipse.uml2.uml.Activity p_activity) {
  ...
  public OpaqueActionBuilder withInStructuredNode(org.eclipse.uml2.uml.StructuredActivityNode p_inStructuredNode) {
  ...
  public OpaqueActionBuilder withIsLeaf(Boolean p_isLeaf) {
    m_isLeaf = p_isLeaf;
    m_featureIsLeafSet = true;
    return this;
  }

  public OpaqueActionBuilder withName(java.lang.String p_name) {
    m_name = p_name;
    m_featureNameSet = true;
    return this;
  }

  public OpaqueActionBuilder withNameExpression(org.eclipse.uml2.uml.StringExpression p_nameExpression) {
  ...
  public OpaqueActionBuilder withVisibility(org.eclipse.uml2.uml.VisibilityKind p_visibility) {
    m_visibility = p_visibility;
    m_featureVisibilitySet = true;
    return this;
  }

  public OpaqueActionBuilder withBody(java.lang.String p_body) {
    m_body.add(p_body);
    m_featureBodySet = true;
    return this;
  }

  public OpaqueActionBuilder withBody(java.util.Collection<? extends java.lang.String> p_body) {
    m_body.addAll(p_body);
    m_featureBodySet = true;
    return this;
  }

  public OpaqueActionBuilder withClientDependency(org.eclipse.uml2.uml.Dependency p_clientDependency) {
    m_clientDependency.add(p_clientDependency);
    m_featureClientDependencySet = true;
    return this;
  }

  public OpaqueActionBuilder withClientDependency(java.util.Collection<? extends org.eclipse.uml2.uml.Dependency> p_clientDependency) {
  ...
  public OpaqueActionBuilder withHandler(org.eclipse.uml2.uml.ExceptionHandler p_handler) {
    m_handler.add(p_handler);
    m_featureHandlerSet = true;
    return this;
  }

  public OpaqueActionBuilder withHandler(java.util.Collection<? extends org.eclipse.uml2.uml.ExceptionHandler> p_handler) {
  ...
  public OpaqueActionBuilder withInInterruptibleRegion(org.eclipse.uml2.uml.InterruptibleActivityRegion p_inInterruptibleRegion) {
    m_inInterruptibleRegion.add(p_inInterruptibleRegion);
    m_featureInInterruptibleRegionSet = true;
    return this;
  }

  public OpaqueActionBuilder withInInterruptibleRegion(java.util.Collection<? extends org.eclipse.uml2.uml.InterruptibleActivityRegion> p_inInterruptibleRegion) {
  ...
  public OpaqueActionBuilder withInPartition(org.eclipse.uml2.uml.ActivityPartition p_inPartition) {
    m_inPartition.add(p_inPartition);
    m_featureInPartitionSet = true;
    return this;
  }

  public OpaqueActionBuilder withInPartition(java.util.Collection<? extends org.eclipse.uml2.uml.ActivityPartition> p_inPartition) {
  ...
  public OpaqueActionBuilder withIncoming(org.eclipse.uml2.uml.ActivityEdge p_incoming) {
    m_incoming.add(p_incoming);
    m_featureIncomingSet = true;
    return this;
  }

  public OpaqueActionBuilder withIncoming(java.util.Collection<? extends org.eclipse.uml2.uml.ActivityEdge> p_incoming) {
  ...
  public OpaqueActionBuilder withInputValue(java.util.Collection<? extends org.eclipse.uml2.uml.InputPin> p_inputValue) {
  ...
  public OpaqueActionBuilder withLanguage(java.lang.String p_language) {
    m_language.add(p_language);
    m_featureLanguageSet = true;
    return this;
  }

  public OpaqueActionBuilder withLanguage(java.util.Collection<? extends java.lang.String> p_language) {
    m_language.addAll(p_language);
    m_featureLanguageSet = true;
    return this;
  }

  public OpaqueActionBuilder withLocalPostcondition(org.eclipse.uml2.uml.Constraint p_localPostcondition) {
    m_localPostcondition.add(p_localPostcondition);
    m_featureLocalPostconditionSet = true;
    return this;
  }

  public OpaqueActionBuilder withLocalPostcondition(java.util.Collection<? extends org.eclipse.uml2.uml.Constraint> p_localPostcondition) {
  ...
  public OpaqueActionBuilder withLocalPrecondition(org.eclipse.uml2.uml.Constraint p_localPrecondition) {
    m_localPrecondition.add(p_localPrecondition);
    m_featureLocalPreconditionSet = true;
    return this;
  }

  public OpaqueActionBuilder withLocalPrecondition(java.util.Collection<? extends org.eclipse.uml2.uml.Constraint> p_localPrecondition) {
  ...
  public OpaqueActionBuilder withOutgoing(org.eclipse.uml2.uml.ActivityEdge p_outgoing) {
    m_outgoing.add(p_outgoing);
    m_featureOutgoingSet = true;
    return this;
  }

  public OpaqueActionBuilder withOutgoing(java.util.Collection<? extends org.eclipse.uml2.uml.ActivityEdge> p_outgoing) {
  ...
  public OpaqueActionBuilder withOutputValue(java.util.Collection<? extends org.eclipse.uml2.uml.OutputPin> p_outputValue) {
    m_outputValue.addAll(p_outputValue);
    m_featureOutputValueSet = true;
    return this;
  }
  ...
  public OpaqueActionBuilder withOwnedComment(org.eclipse.uml2.uml.Comment p_ownedComment) {
    m_ownedComment.add(p_ownedComment);
    m_featureOwnedCommentSet = true;
    return this;
  }

  public OpaqueActionBuilder withOwnedComment(java.util.Collection<? extends org.eclipse.uml2.uml.Comment> p_ownedComment) {
  ...
  public OpaqueActionBuilder withRedefinedNode(org.eclipse.uml2.uml.ActivityNode p_redefinedNode) {
