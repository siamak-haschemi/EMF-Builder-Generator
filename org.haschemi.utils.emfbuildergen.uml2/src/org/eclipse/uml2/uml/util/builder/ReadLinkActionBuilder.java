 ...
 * @generated
 */
public class ReadLinkActionBuilder {
  ...
  private java.util.Collection<org.eclipse.uml2.uml.util.builder.LinkEndDataBuilder> m_featureEndDataBuilder = new java.util.LinkedList<org.eclipse.uml2.uml.util.builder.LinkEndDataBuilder>();
  ...
  public org.eclipse.uml2.uml.ReadLinkAction build() {
    ...
    if (m_featureEndDataSet) {
      ...
      if (!m_featureEndDataBuilder.isEmpty()) {
        for (LinkEndDataBuilder builder : m_featureEndDataBuilder) {
  ...
  public ReadLinkActionBuilder withActivity(org.eclipse.uml2.uml.util.builder.ActivityBuilder p_activityBuilder) {
  ...
  public ReadLinkActionBuilder withInStructuredNode(org.eclipse.uml2.uml.util.builder.StructuredActivityNodeBuilder p_structuredActivityNodeBuilder) {
  ...
  public ReadLinkActionBuilder withNameExpression(org.eclipse.uml2.uml.util.builder.StringExpressionBuilder p_stringExpressionBuilder) {
  ...
  public ReadLinkActionBuilder withResult(org.eclipse.uml2.uml.util.builder.OutputPinBuilder p_outputPinBuilder) {
  ...
  public ReadLinkActionBuilder withClientDependency(DependencyBuilder p_dependencyBuilder) {
  ...
  public ReadLinkActionBuilder withEndData(LinkEndDataBuilder p_linkEndDataBuilder) {
  ...
  public ReadLinkActionBuilder withHandler(ExceptionHandlerBuilder p_exceptionHandlerBuilder) {
  ...
  public ReadLinkActionBuilder withInInterruptibleRegion(InterruptibleActivityRegionBuilder p_interruptibleActivityRegionBuilder) {
  ...
  public ReadLinkActionBuilder withInPartition(ActivityPartitionBuilder p_activityPartitionBuilder) {
  ...
  public ReadLinkActionBuilder withInputValue(InputPinBuilder p_inputPinBuilder) {
  ...
  public ReadLinkActionBuilder withLocalPostcondition(ConstraintBuilder p_constraintBuilder) {
  ...
  public ReadLinkActionBuilder withLocalPrecondition(ConstraintBuilder p_constraintBuilder) {
  ...
  public ReadLinkActionBuilder withOwnedComment(CommentBuilder p_commentBuilder) {
