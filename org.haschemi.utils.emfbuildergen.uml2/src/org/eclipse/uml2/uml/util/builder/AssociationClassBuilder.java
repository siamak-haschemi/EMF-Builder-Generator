 ...
 * @generated
 */
public class AssociationClassBuilder {
  ...
  private java.util.Collection<org.eclipse.uml2.uml.util.builder.PropertyBuilder> m_featureMemberEndBuilder = new java.util.LinkedList<org.eclipse.uml2.uml.util.builder.PropertyBuilder>();
  ...
  private java.util.Collection<org.eclipse.uml2.uml.util.builder.PropertyBuilder> m_featureNavigableOwnedEndBuilder = new java.util.LinkedList<org.eclipse.uml2.uml.util.builder.PropertyBuilder>();
  ...
  private java.util.Collection<org.eclipse.uml2.uml.util.builder.PropertyBuilder> m_featureOwnedEndBuilder = new java.util.LinkedList<org.eclipse.uml2.uml.util.builder.PropertyBuilder>();
  ...
  public org.eclipse.uml2.uml.AssociationClass build() {
    ...
    if (m_featureMemberEndSet) {
      ...
      if (!m_featureMemberEndBuilder.isEmpty()) {
        for (PropertyBuilder builder : m_featureMemberEndBuilder) {
    ...
    if (m_featureNavigableOwnedEndSet) {
      ...
      if (!m_featureNavigableOwnedEndBuilder.isEmpty()) {
        for (PropertyBuilder builder : m_featureNavigableOwnedEndBuilder) {
    ...
    if (m_featureOwnedEndSet) {
      ...
      if (!m_featureOwnedEndBuilder.isEmpty()) {
        for (PropertyBuilder builder : m_featureOwnedEndBuilder) {
  ...
  public AssociationClassBuilder withNameExpression(org.eclipse.uml2.uml.util.builder.StringExpressionBuilder p_stringExpressionBuilder) {
  ...
  public AssociationClassBuilder withOwnedTemplateSignature(org.eclipse.uml2.uml.util.builder.TemplateSignatureBuilder p_templateSignatureBuilder) {
  ...
  public AssociationClassBuilder withOwningTemplateParameter(org.eclipse.uml2.uml.util.builder.TemplateParameterBuilder p_templateParameterBuilder) {
  ...
  public AssociationClassBuilder withRepresentation(org.eclipse.uml2.uml.util.builder.CollaborationUseBuilder p_collaborationUseBuilder) {
  ...
  public AssociationClassBuilder withTemplateParameter(org.eclipse.uml2.uml.util.builder.TemplateParameterBuilder p_templateParameterBuilder) {
  ...
  public AssociationClassBuilder withClientDependency(DependencyBuilder p_dependencyBuilder) {
  ...
  public AssociationClassBuilder withCollaborationUse(CollaborationUseBuilder p_collaborationUseBuilder) {
  ...
  public AssociationClassBuilder withElementImport(ElementImportBuilder p_elementImportBuilder) {
  ...
  public AssociationClassBuilder withGeneralization(GeneralizationBuilder p_generalizationBuilder) {
  ...
  public AssociationClassBuilder withInterfaceRealization(InterfaceRealizationBuilder p_interfaceRealizationBuilder) {
  ...
  public AssociationClassBuilder withMemberEnd(PropertyBuilder p_propertyBuilder) {
  ...
  public AssociationClassBuilder withNavigableOwnedEnd(PropertyBuilder p_propertyBuilder) {
  ...
  public AssociationClassBuilder withOwnedAttribute(PropertyBuilder p_propertyBuilder) {
  ...
  public AssociationClassBuilder withOwnedComment(CommentBuilder p_commentBuilder) {
  ...
  public AssociationClassBuilder withOwnedConnector(ConnectorBuilder p_connectorBuilder) {
  ...
  public AssociationClassBuilder withOwnedEnd(PropertyBuilder p_propertyBuilder) {
  ...
  public AssociationClassBuilder withOwnedOperation(OperationBuilder p_operationBuilder) {
  ...
  public AssociationClassBuilder withOwnedReception(ReceptionBuilder p_receptionBuilder) {
  ...
  public AssociationClassBuilder withOwnedRule(ConstraintBuilder p_constraintBuilder) {
  ...
  public AssociationClassBuilder withOwnedTrigger(TriggerBuilder p_triggerBuilder) {
  ...
  public AssociationClassBuilder withOwnedUseCase(UseCaseBuilder p_useCaseBuilder) {
  ...
  public AssociationClassBuilder withPackageImport(PackageImportBuilder p_packageImportBuilder) {
  ...
  public AssociationClassBuilder withPowertypeExtent(GeneralizationSetBuilder p_generalizationSetBuilder) {
  ...
  public AssociationClassBuilder withSubstitution(SubstitutionBuilder p_substitutionBuilder) {
  ...
  public AssociationClassBuilder withTemplateBinding(TemplateBindingBuilder p_templateBindingBuilder) {
  ...
  public AssociationClassBuilder withUseCase(UseCaseBuilder p_useCaseBuilder) {
