...
public class ComponentBuilder {
  ...
  private java.util.Collection<org.eclipse.uml2.uml.util.builder.ComponentRealizationBuilder> m_featureRealizationBuilder = new java.util.LinkedList<org.eclipse.uml2.uml.util.builder.ComponentRealizationBuilder>();
  ...
  public org.eclipse.uml2.uml.Component build() {
    ...
    if (m_featureRealizationSet) {
      ...
      if (!m_featureRealizationBuilder.isEmpty()) {
        for (ComponentRealizationBuilder builder : m_featureRealizationBuilder) {
  ...
  public ComponentBuilder withNameExpression(org.eclipse.uml2.uml.util.builder.StringExpressionBuilder p_stringExpressionBuilder) {
  ...
  public ComponentBuilder withOwnedTemplateSignature(org.eclipse.uml2.uml.util.builder.TemplateSignatureBuilder p_templateSignatureBuilder) {
  ...
  public ComponentBuilder withOwningTemplateParameter(org.eclipse.uml2.uml.util.builder.TemplateParameterBuilder p_templateParameterBuilder) {
  ...
  public ComponentBuilder withRepresentation(org.eclipse.uml2.uml.util.builder.CollaborationUseBuilder p_collaborationUseBuilder) {
  ...
  public ComponentBuilder withTemplateParameter(org.eclipse.uml2.uml.util.builder.TemplateParameterBuilder p_templateParameterBuilder) {
  ...
  public ComponentBuilder withClientDependency(DependencyBuilder p_dependencyBuilder) {
  ...
  public ComponentBuilder withCollaborationUse(CollaborationUseBuilder p_collaborationUseBuilder) {
  ...
  public ComponentBuilder withElementImport(ElementImportBuilder p_elementImportBuilder) {
  ...
  public ComponentBuilder withGeneralization(GeneralizationBuilder p_generalizationBuilder) {
  ...
  public ComponentBuilder withInterfaceRealization(InterfaceRealizationBuilder p_interfaceRealizationBuilder) {
  ...
  public ComponentBuilder withOwnedAttribute(PropertyBuilder p_propertyBuilder) {
  ...
  public ComponentBuilder withOwnedComment(CommentBuilder p_commentBuilder) {
  ...
  public ComponentBuilder withOwnedConnector(ConnectorBuilder p_connectorBuilder) {
  ...
  public ComponentBuilder withOwnedOperation(OperationBuilder p_operationBuilder) {
  ...
  public ComponentBuilder withOwnedReception(ReceptionBuilder p_receptionBuilder) {
  ...
  public ComponentBuilder withOwnedRule(ConstraintBuilder p_constraintBuilder) {
  ...
  public ComponentBuilder withOwnedTrigger(TriggerBuilder p_triggerBuilder) {
  ...
  public ComponentBuilder withOwnedUseCase(UseCaseBuilder p_useCaseBuilder) {
  ...
  public ComponentBuilder withPackageImport(PackageImportBuilder p_packageImportBuilder) {
  ...
  public ComponentBuilder withPowertypeExtent(GeneralizationSetBuilder p_generalizationSetBuilder) {
  ...
  public ComponentBuilder withRealization(ComponentRealizationBuilder p_componentRealizationBuilder) {
  ...
  public ComponentBuilder withSubstitution(SubstitutionBuilder p_substitutionBuilder) {
  ...
  public ComponentBuilder withTemplateBinding(TemplateBindingBuilder p_templateBindingBuilder) {
  ...
  public ComponentBuilder withUseCase(UseCaseBuilder p_useCaseBuilder) {
