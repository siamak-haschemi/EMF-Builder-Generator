 ...
 * @generated
 */
public class InformationFlowBuilder {
  ...
  private java.util.Collection<org.eclipse.uml2.uml.util.builder.ConnectorBuilder> m_featureRealizingConnectorBuilder = new java.util.LinkedList<org.eclipse.uml2.uml.util.builder.ConnectorBuilder>();
  ...
  private java.util.Collection<org.eclipse.uml2.uml.util.builder.MessageBuilder> m_featureRealizingMessageBuilder = new java.util.LinkedList<org.eclipse.uml2.uml.util.builder.MessageBuilder>();
  // helper attributes
  ...
  public org.eclipse.uml2.uml.InformationFlow build() {
    ...
    if (m_featureRealizingConnectorSet) {
      ...
      if (!m_featureRealizingConnectorBuilder.isEmpty()) {
        for (ConnectorBuilder builder : m_featureRealizingConnectorBuilder) {
    ...
    if (m_featureRealizingMessageSet) {
      ...
      if (!m_featureRealizingMessageBuilder.isEmpty()) {
        for (MessageBuilder builder : m_featureRealizingMessageBuilder) {
  ...
  public InformationFlowBuilder withNameExpression(org.eclipse.uml2.uml.util.builder.StringExpressionBuilder p_stringExpressionBuilder) {
  ...
  public InformationFlowBuilder withOwningTemplateParameter(org.eclipse.uml2.uml.util.builder.TemplateParameterBuilder p_templateParameterBuilder) {
  ...
  public InformationFlowBuilder withTemplateParameter(org.eclipse.uml2.uml.util.builder.TemplateParameterBuilder p_templateParameterBuilder) {
  ...
  public InformationFlowBuilder withClientDependency(DependencyBuilder p_dependencyBuilder) {
  ...
  public InformationFlowBuilder withOwnedComment(CommentBuilder p_commentBuilder) {
  ...
  public InformationFlowBuilder withRealizingConnector(ConnectorBuilder p_connectorBuilder) {
  ...
  public InformationFlowBuilder withRealizingMessage(MessageBuilder p_messageBuilder) {
