...
public class ExecutionEnvironmentBuilder {
  ...
  private java.util.Collection<org.eclipse.uml2.uml.util.builder.NodeBuilder> m_featureNestedNodeBuilder = new java.util.LinkedList<org.eclipse.uml2.uml.util.builder.NodeBuilder>();
  ...
  public org.eclipse.uml2.uml.ExecutionEnvironment build() {
    ...
    if (m_featureNestedNodeSet) {
      ...
      if (!m_featureNestedNodeBuilder.isEmpty()) {
        for (NodeBuilder builder : m_featureNestedNodeBuilder) {
  ...
  public ExecutionEnvironmentBuilder withNameExpression(org.eclipse.uml2.uml.util.builder.StringExpressionBuilder p_stringExpressionBuilder) {
  ...
  public ExecutionEnvironmentBuilder withOwnedTemplateSignature(org.eclipse.uml2.uml.util.builder.TemplateSignatureBuilder p_templateSignatureBuilder) {
  ...
  public ExecutionEnvironmentBuilder withOwningTemplateParameter(org.eclipse.uml2.uml.util.builder.TemplateParameterBuilder p_templateParameterBuilder) {
  ...
  public ExecutionEnvironmentBuilder withRepresentation(org.eclipse.uml2.uml.util.builder.CollaborationUseBuilder p_collaborationUseBuilder) {
  ...
  public ExecutionEnvironmentBuilder withTemplateParameter(org.eclipse.uml2.uml.util.builder.TemplateParameterBuilder p_templateParameterBuilder) {
  ...
  public ExecutionEnvironmentBuilder withClientDependency(DependencyBuilder p_dependencyBuilder) {
  ...
  public ExecutionEnvironmentBuilder withCollaborationUse(CollaborationUseBuilder p_collaborationUseBuilder) {
  ...
  public ExecutionEnvironmentBuilder withDeployment(DeploymentBuilder p_deploymentBuilder) {
  ...
  public ExecutionEnvironmentBuilder withElementImport(ElementImportBuilder p_elementImportBuilder) {
  ...
  public ExecutionEnvironmentBuilder withGeneralization(GeneralizationBuilder p_generalizationBuilder) {
  ...
  public ExecutionEnvironmentBuilder withInterfaceRealization(InterfaceRealizationBuilder p_interfaceRealizationBuilder) {
  ...
  public ExecutionEnvironmentBuilder withNestedNode(NodeBuilder p_nodeBuilder) {
  ...
  public ExecutionEnvironmentBuilder withOwnedAttribute(PropertyBuilder p_propertyBuilder) {
  ...
  public ExecutionEnvironmentBuilder withOwnedComment(CommentBuilder p_commentBuilder) {
  ...
  public ExecutionEnvironmentBuilder withOwnedConnector(ConnectorBuilder p_connectorBuilder) {
  ...
  public ExecutionEnvironmentBuilder withOwnedOperation(OperationBuilder p_operationBuilder) {
  ...
  public ExecutionEnvironmentBuilder withOwnedReception(ReceptionBuilder p_receptionBuilder) {
  ...
  public ExecutionEnvironmentBuilder withOwnedRule(ConstraintBuilder p_constraintBuilder) {
  ...
  public ExecutionEnvironmentBuilder withOwnedTrigger(TriggerBuilder p_triggerBuilder) {
  ...
  public ExecutionEnvironmentBuilder withOwnedUseCase(UseCaseBuilder p_useCaseBuilder) {
  ...
  public ExecutionEnvironmentBuilder withPackageImport(PackageImportBuilder p_packageImportBuilder) {
  ...
  public ExecutionEnvironmentBuilder withPowertypeExtent(GeneralizationSetBuilder p_generalizationSetBuilder) {
  ...
  public ExecutionEnvironmentBuilder withSubstitution(SubstitutionBuilder p_substitutionBuilder) {
  ...
  public ExecutionEnvironmentBuilder withTemplateBinding(TemplateBindingBuilder p_templateBindingBuilder) {
  ...
  public ExecutionEnvironmentBuilder withUseCase(UseCaseBuilder p_useCaseBuilder) {
