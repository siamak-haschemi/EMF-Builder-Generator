 ...
 * @generated
 */
public class CreateLinkActionBuilder {
  ...
  public CreateLinkActionBuilder withActivity(org.eclipse.uml2.uml.util.builder.ActivityBuilder p_activityBuilder) {
  ...
  public CreateLinkActionBuilder withInStructuredNode(org.eclipse.uml2.uml.util.builder.StructuredActivityNodeBuilder p_structuredActivityNodeBuilder) {
  ...
  public CreateLinkActionBuilder withNameExpression(org.eclipse.uml2.uml.util.builder.StringExpressionBuilder p_stringExpressionBuilder) {
  ...
  public CreateLinkActionBuilder withClientDependency(DependencyBuilder p_dependencyBuilder) {
  ...
  public CreateLinkActionBuilder withEndData(LinkEndDataBuilder p_linkEndDataBuilder) {
  ...
  public CreateLinkActionBuilder withHandler(ExceptionHandlerBuilder p_exceptionHandlerBuilder) {
  ...
  public CreateLinkActionBuilder withInInterruptibleRegion(InterruptibleActivityRegionBuilder p_interruptibleActivityRegionBuilder) {
  ...
  public CreateLinkActionBuilder withInPartition(ActivityPartitionBuilder p_activityPartitionBuilder) {
  ...
  public CreateLinkActionBuilder withInputValue(InputPinBuilder p_inputPinBuilder) {
  ...
  public CreateLinkActionBuilder withLocalPostcondition(ConstraintBuilder p_constraintBuilder) {
  ...
  public CreateLinkActionBuilder withLocalPrecondition(ConstraintBuilder p_constraintBuilder) {
  ...
  public CreateLinkActionBuilder withOwnedComment(CommentBuilder p_commentBuilder) {
