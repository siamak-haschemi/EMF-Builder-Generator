...
public class OrganizationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case OrganizationPackage.EMPLOYEE: {
				...
				if (result == null) result = caseABase(employee);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OrganizationPackage.COMPANY: {
				Company company = (Company)theEObject;
				T result = caseCompany(company);
				if (result == null) result = caseABase(company);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OrganizationPackage.DEPARTMENT: {
				Department department = (Department)theEObject;
				T result = caseDepartment(department);
				if (result == null) result = caseABase(department);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OrganizationPackage.ABASE: {
				ABase aBase = (ABase)theEObject;
				T result = caseABase(aBase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>ABase</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>ABase</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseABase(ABase object) {
		return null;
	}
